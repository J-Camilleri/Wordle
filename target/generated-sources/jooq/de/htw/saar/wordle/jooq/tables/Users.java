...
public class Users extends TableImpl<UsersRecord> {
    ...
    /**
     * Get the implicit to-many join path to the <code>scoreboard</code> table
     */
    public ScoreboardPath scoreboard() {
        if (_scoreboard == null)
            _scoreboard = new ScoreboardPath(this, null, Keys.SCOREBOARD__FK_SCOREBOARD_PK_USERS.getInverseKey());
